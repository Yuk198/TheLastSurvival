...
class Background():
	...
	pine1_img = pygame.image.load('Assets/Image/Background/pine1.png').convert_alpha()
	skycloud_img = pygame.image.load('Assets/Image/Background/sky_cloud.png').convert_alpha()