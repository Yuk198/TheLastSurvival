...
class Button():
	...
	setting_button = Config.Client(Screen.Resolution.SCREEN_WIDTH // 2 - 130, Screen.Resolution.SCREEN_HEIGHT // 2 - 50, Screen.Menu.setting_img, 1)
	exit_button = Config.Client(Screen.Resolution.SCREEN_WIDTH // 2 - 130, Screen.Resolution.SCREEN_HEIGHT // 2 + 50, Screen.Menu.exit_img, 1)
